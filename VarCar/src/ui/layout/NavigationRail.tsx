    ...
    <>
      ...
      >
        ...
        <div className="mb-4 flex items-center justify-center">
          <svg width="35" height="53" viewBox="0 0 35 53" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
            ...
            <text x="0" y="48" fontSize="10" fill="currentColor" fontFamily="Inter, sans-serif" fontWeight="600">Token</text>
            <text x="22" y="60" fontSize="10" fill="currentColor" fontFamily="Inter, sans-serif" fontWeight="600">Link</text>
          </svg>
        </div>
